    ...
    <div className="row">
      ...
      <div className="nine columns main-col">
        ...
        <p>
          ...
          <br />
          The potential, people and stories inspired me, and little by little, I
          was drawn in. Not long after I started my new career and almost
          suddenly I'm able to do all these amazing things. Must be Magic.
        </p>
        <div className="row">
          ...
          <div className="columns download">
            <p>
              <a
                href="https://resume.creddle.io/resume/6kv0z12yze3"
                className="button"
              >
                <FaCloudDownload />
                Download Resume
